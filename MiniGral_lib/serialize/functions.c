...
t_stream* serializeStruct_tcbINNC(t_struct_string* estructuraOrigen){
...
t_stream* serializeStruct_tcbOUTN(t_struct_string* estructuraOrigen){
...
t_stream* serializeStruct_tcbOUTC(t_struct_string* estructuraOrigen){
